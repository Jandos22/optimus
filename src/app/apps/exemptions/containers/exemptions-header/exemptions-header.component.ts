...
@Component({
  ...
  styleUrls: ['exemptions-header.component.scss'],
  encapsulation: ViewEncapsulation.None,
  changeDetection: ChangeDetectionStrategy.OnPush,
  template: `
    <app-exemptions-toolbar class="common-toolbar"
    ...
    </app-exemptions-toolbar>
    `
})
export class ExemptionsHeaderComponent implements OnInit, OnDestroy {
  ...
  subscribeToParamsFormGroup() {
    ...
    this.$params = params$
      ...
      .subscribe((params: ExemptionsSearchParams) => {
        console.log('params updated');
        // this action updates store > exemptions.params
        // this action is intercepted in search effects
        // search effects triggers chain of actions needed
        // to request exemptions from server and load them in store
        this.store_exemptions.dispatch(new fromExemptions.UpdateParams(params));
      });
  }
