...
@Component({
  selector: 'app-appraisals-form-quality',
  styleUrls: ['appraisals-form-quality.component.scss'],
  ...
  template: `
    <div class="appraisals-skill-container" fxLayout="row wrap" FxLayoutAlign="start start">
      ...
      <div class="appraisals-row-main" fxLayout="row nowrap" fxLayoutAlign="space-between center">
        ...
        <div fxFlex class="skill-title"><fa-icon [icon]="['fas', 'info-circle']" [matTooltip]="description"></fa-icon> Quality</div>
    ...
    <mat-form-field fxFlex="100" [formGroup]="fg_fields" class="appraisal-description-container">
        <textarea matInput
          formControlName="QualityDetails"
          cdkTextareaAutosize
...
export class AppraisalsFormQualityComponent implements OnInit, OnChanges {
  ...
  description = 'Efficient work during pre/post-job and job execution';
  ...
  options: AppraisalSkillItem[] = [
    { value: 'A', selected: false, description: 'Outstanding' },
    {
      value: 'B',
      selected: false,
      description: 'No failures. Efficient job.'
    },
    {
      value: 'C',
      selected: false,
      description: 'No failures or forgotten equipment at base/wellsite'
    },
