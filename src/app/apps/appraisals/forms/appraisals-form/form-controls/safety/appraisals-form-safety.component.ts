...
@Component({
  selector: 'app-appraisals-form-safety',
  styleUrls: ['appraisals-form-safety.component.scss'],
  ...
  template: `
    <div class="appraisals-skill-container" fxLayout="row wrap" FxLayoutAlign="start start">
      ...
      <div class="appraisals-row-main" fxLayout="row nowrap" fxLayoutAlign="space-between center">
        ...
        <div fxFlex class="skill-title"><fa-icon [icon]="['fas', 'info-circle']" [matTooltip]="description"></fa-icon> Safety</div>
...
export class AppraisalsFormSafetyComponent implements OnInit, OnChanges {
  ...
  description =
    'Adherence to safety and all applicable regulations/procedures/rules';
  ...
  options: AppraisalSkillItem[] = [
    { value: 'A', selected: false, description: 'Outstanding' },
    {
      value: 'B',
      selected: false,
      description: 'Continuously enforce safe work'
    },
    {
      value: 'C',
      selected: false,
