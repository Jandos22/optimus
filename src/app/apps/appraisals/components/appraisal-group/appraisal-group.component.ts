...
@Component({
  ...
  template: `
    <div class="appraisal-group-container">
      ...
      <div
        class="appraisal-item-container"
        *ngFor="let appraisal of job.appraisals"
        fxLayout="row wrap"
        fxLayoutAlign="start start"
        (click)="openForm.emit(appraisal)"
      >
        <div class="given-for" fxFlex="100%" fxFlex.gt-xs="180px">
          <app-appraisal-given-for
            [viewPerson]="appraisal.GivenFor"
          ></app-appraisal-given-for>
        </div>
        ...
        >
          ...
          >
            ...
            >
              <div class="score" *ngIf="appraisal.Safety !== 'A'">
                {{ appraisal.Safety }}
              </div>
              <div
                class="score"
                *ngIf="appraisal.Safety === 'A'"
                [ngClass]="{ A: appraisal.Safety === 'A' }"
              >
                <fa-icon [icon]="['fas', 'star']"></fa-icon>
              </div>
              <div class="factor" [ngClass]="{ A: appraisal.Safety === 'A' }">
                safety
              </div>
            </div>
            ...
            <div
              ...
              matTooltipClass="mytooltip large-text"
            >
              <div class="score" *ngIf="appraisal.Proactivity !== 'A'">
                {{ appraisal.Proactivity }}
              </div>
              <div
                class="score"
                *ngIf="appraisal.Proactivity === 'A'"
                [ngClass]="{ A: appraisal.Proactivity === 'A' }"
              >
                <fa-icon [icon]="['fas', 'star']"></fa-icon>
              </div>
              <div
            ...
            <div
              ...
              matTooltipClass="mytooltip large-text"
            >
              <div class="score" *ngIf="appraisal.Quality !== 'A'">
                {{ appraisal.Quality }}
              </div>
              <div
                class="score"
                *ngIf="appraisal.Quality === 'A'"
                [ngClass]="{ A: appraisal.Quality === 'A' }"
              >
                <fa-icon [icon]="['fas', 'star']"></fa-icon>
              </div>
              <div class="factor" [ngClass]="{ A: appraisal.Quality === 'A' }">
                quality
              </div>
            </div>

            <div
              [ngClass]="['key-factor', appraisal.WinchDriving]"
              [matTooltip]="appraisal.WinchDrivingDetails"
              matTooltipClass="mytooltip large-text"
            >
              <div class="score" *ngIf="appraisal.WinchDriving !== 'A'">
                {{ appraisal.WinchDriving }}
              </div>
              <div
                class="score"
                *ngIf="appraisal.WinchDriving === 'A'"
                [ngClass]="{ A: appraisal.WinchDriving === 'A' }"
              >
                <fa-icon [icon]="['fas', 'star']"></fa-icon>
              </div>
              <div
                class="factor"
                [ngClass]="{ A: appraisal.QualWinchDrivingity === 'A' }"
              >
                winch
              </div>
            </div>
          ...
          >
            ...
            <div
              class="key-skill"
              [ngClass]="{ did: appraisal.DidRopeSocket }"
            ...
            <div
              class="key-skill"
              [ngClass]="{ did: appraisal.DidRopeSocketH2S }"
            ...
            <div
              class="key-skill"
              [ngClass]="{ did: appraisal.DidCollector }"
