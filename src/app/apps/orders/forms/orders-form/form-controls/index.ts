...
import { OrdersFormLastUpdatedFlagComponent } from './last-updated-flag/orders-form-last-updated-flag.component';
...
export const forms_controls: any[] = [
  ...
  OrdersFormLastUpdatedFlagComponent
];
...
export * from './last-updated-flag/orders-form-last-updated-flag.component';
