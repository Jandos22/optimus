...
@Component({
  ...
  template: `
    <div class="filters-content-container">
      ...
      <app-jobs-filters-rigs [fg_filters]="fg_filters" fxLayout="row nowrap">
      </app-jobs-filters-rigs>
      ...
      <app-form-control-people-selector
        ...
        [selfUser]="selfUser"
        [doReset]="doReset"
        (onSelectUser)="onSelectEngineers.emit($event)"
        [forFilters]="true"
        [includeOnly]="engineerIds"
      >
      </app-form-control-people-selector>
      ...
      <app-form-control-people-selector
        ...
        [selfUser]="selfUser"
        [doReset]="doReset"
        (onSelectUser)="onSelectOperators.emit($event)"
        [forFilters]="true"
        [includeOnly]="operatorsIds"
      >
      </app-form-control-people-selector>
    </div>
  `
