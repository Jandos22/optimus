...
export class PeopleFiltersComponent implements OnInit, OnChanges {
  @Input()
  filterParams: SearchParamsUser;

  @Output()
  toggleFilters = new EventEmitter<any>();

  @Output()
  onFiltersUpdate = new EventEmitter<SearchParamsUser>();
  ...
  constructor(
    ...
    private store_timeline: Store<fromPeople.PeopleState>,
  ...
  startSubscriptions() {
    ...
    this.fg_filters.valueChanges
      ...
      .subscribe((params: SearchParamsUser) => {
        ...
        this.store_timeline.dispatch(new fromPeople.UpdateParams(params));
      });
