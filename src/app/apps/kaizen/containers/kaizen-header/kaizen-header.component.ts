...
@Component({
  ...
  styleUrls: ['kaizen-header.component.scss'],
  encapsulation: ViewEncapsulation.None,
  changeDetection: ChangeDetectionStrategy.OnPush,
  template: `
    <app-kaizen-toolbar class="common-toolbar"
...
export class KaizenHeaderComponent implements OnInit, OnDestroy {
  ...
  subscribeToParamsFormGroup() {
    ...
    this.$params = params$
      ...
      .subscribe((params: KaizenSearchParams) => {
        ...
        // this action updates store > kaizen.params
        // this action is intercepted in search effects
        // search effects triggers chain of actions needed
        // to request projects from server and load them in store
