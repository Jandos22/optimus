...
@Component({
  selector: 'app-kaizen-form-actions-edit',
  styleUrls: ['kaizen-form-actions-edit.component.scss'],
  template: `
    ...
    <app-kaizen-form-actions-edit-fields
      [fg_fields]="fg_fields" [initialFields]="initialFields"
      (whenUnsavedFieldsChange)="unsavedFieldsChange($event)">
    </app-kaizen-form-actions-edit-fields>
    `
})
export class KaizenFormActionsEditComponent implements OnInit, OnDestroy {
  ...
  constructor(
    ...
    console.log('kaizen-form-actions-edit: initialized');
  }
  ...
  saveFieldsSuccess(updatedItem: KaizenProjectItem) {
  ...
  getAllFieldsOfUpdatedItem(updatedItem: KaizenProjectItem) {
      ...
      .subscribe(
        success =>
          this.getAllFieldsOfUpdatedItemSuccees(
            success[0] as KaizenProjectItem
          ),
  ...
  getAllFieldsOfUpdatedItemSuccees(fullItem: KaizenProjectItem) {
    ...
    this.store_kaizen.dispatch(
      new fromProjectsActions.UpdateOneProject(fullItem.ID, fullItem)
    );
  ...
  saveImageSuccess(newImage) {
    ...
    this.store_kaizen.dispatch(
      new fromProjectsActions.UpdateOneProject(this.initialFields.ID, changes)
    );
