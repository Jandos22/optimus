...
@Component({
  selector: 'app-harcs-form-quest-qpid',
  styleUrls: ['harcs-form-quest-qpid.component.scss'],
...
export class HarcsFormQuestQpidComponent {
  ...
  openQuest() {
    ...
    if (qpid) {
      window.open(
        `https://quest.slb.com/quest/Harc/HarcVIEW.asp?QPID=${qpid}`,
        '_blank'
      );
    }
  }
